...
* News
- Apparently, you were all so eager to download the screencasts that the provider disabled further downloads due to excessive traffic. For now, you can find the screencasts, lecture slides and exercises [[https://uni-koeln.sciebo.de/s/urCdimezGeZTWDu][here]]. Please, download only once and not repeatedly. 
...
* Material
All materials are now on [[https://uni-koeln.sciebo.de/s/urCdimezGeZTWDu][sciebo]].  
 - slides
