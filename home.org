...
- *There is no exercise session in week 1. As the lecturer is ill, there is also no on campus lecture in week 1. Instead a screencast with the material of the first lecture will be uploaded here on Oct 14. Please watch this screencast and prepare exercises 1 to 3 before the exercise session next Wednesday.*
